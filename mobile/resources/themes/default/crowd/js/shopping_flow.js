...
{
  $.get('index.php?r=crowd_funding/index/Shippingfee', {shipping: obj}, function(data){
...
function selectPayment(value)
{
  ...
  $.get('index.php?r=flow/index/select_payment', {payment:value,shipping_id:arr}, function(data){
...
function selectPack(value)
{
  ...
  $.get('index.php?r=flow/index/select_pack', {pack:value}, function(data){
    orderSelectedResponse(data);
  }, 'json');
}
...
function changeIntegral(val)
{
 ...
 else
 {
  ...
  $.get('index.php?r=flow/index/change_integral', {points: val,shipping_id:arr}, function(data){
...
function changeNeedInv()
{
  ...
  $.get('index.php?r=flow/index/change_needinv', {need_inv:needInv, inv_type:encodeURIComponent(invType), inv_payee:encodeURIComponent(invPayee), inv_content:encodeURIComponent(invContent)}, function(data){
    orderSelectedResponse(data);
  });
