...
class alipay
{
    ...
    public function get_code($order, $payment)
    {
        ...
        /* 生成支付按钮 */
        $button = '<script type="text/javascript" src="resources/assets/script/ap.js"></script><a  type="button" class="box-flex btn-submit" onclick="javascript:_AP.pay(\'' . $gateway . $param . '&sign=' . md5($sign) . '\')">支付宝支付</a>';
