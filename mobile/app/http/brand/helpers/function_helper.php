...
//{
//    $sql = 'SELECT COUNT(*) FROM {pre}goods AS g ' .
 ...
 * @return array
 */
function brand_get_goods($brand_id, $mbid = 0, $cate, $size, $page, $sort, $order, $warehouse_id = 0, $area_id = 0, $act = '', $is_ship = '', $price_min, $price_max)
{
    $cate_where = ($cate > 0) ? 'AND ' . get_children($cate) : '';
...
function brand_get_goods_ajax($brand_id, $mbid, $cate, $size, $page, $sort, $order, $warehouse_id = 0, $area_id = 0, $act = '', $is_ship = '', $price_min = 0, $price_max = 0,$type = '')
{
    $cate_where = ($cate > 0) ? 'AND ' . get_children($cate) : '';
