...
class UploadController extends BackendController {
    ...
    public function __construct() {
        ...
        $this->content = file_get_contents(ROOT_PATH . "resources/assets/editor/config.json");
        $this->conf = json_decode(preg_replace("/\/\*[\s\S]+?\*\//", "", str_replace(array('__ROOT__', '__HOST__'), array(dirname(__ROOT__), __HOST__), $this->content)), true);
    }
    ...
    private function uploads() {
        ...
        /* 生成上传实例对象并完成上传 */
        $up = new \libraries\Uploader($fieldName, $config, $base64);
