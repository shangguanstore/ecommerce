...
namespace http\sms\controllers;
...
class IndexController extends FrontendController {
    ...
    public function actionSend() {
        ...
        if ($this->flag == 'register') {
            $message = array('code' => $this->mobile_code, 'product' => C('shop.shop_name'));
            $send_type = 'sms_signin';
        }
        ...
        $send_result = send_sms($this->mobile, $send_type, $message);
