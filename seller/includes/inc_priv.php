...
//商家入驻管理部分的权限 ecmoban模板堂 --zhuo start
    ...
    $purview['10_account_manage']             = 'seller_account'; //商家资金管理
...
//ecmoban模板堂 --zhuo end	
    ...
    $purview['01_drp_shop'] = 'drp_shop';
    $purview['01_drp_list'] = 'drp_list';
    $purview['01_drp_order_list'] = 'drp_order_list';
    $purview['01_drp_set_config'] = 'drp_set_config';
?>