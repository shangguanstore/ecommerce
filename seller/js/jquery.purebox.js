		...
		_init : function(options) {
			var opts = $.extend({}, purebox.defaults, options || {}),
				template = ['<div id="',opts.id,'" class="pb"><div class="cboxContent">',
				           opts.head ? ('<div class="pb-hd">' + (opts.xBtn ? '<a class="pb-x">X</a>' : '') + '<span class="pb-title">'+opts.title+'</span></div>') : '',
				           '<div class="pb-bd"><div class="pb-ct"></div></div>' + ( opts.timeCozuo ? '<div class="dialog_buttons_bar"><time class="countdown"><i class="icon-time"></i><span id="time">' +opts.time+ '</span> 秒后窗口关闭</time>':''),
			               opts.foot ? ('<div class="pb-ft">'+(opts.cBtn ? '<a class="pb-btn pb-ok">\u786e\u5b9a</a>' : '') + '<a class="pb-btn pb-cl">\u53d6\u6d88</a></div>') : '','</div></div></div>'].join(''),
			    $pb = $(template),
				$head = $pb.find('.pb-hd'),
				$foot = $pb.find('.pb-ft'),
				that = this;
