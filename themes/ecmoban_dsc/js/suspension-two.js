...
var str = '<style type="text/css">';
    ...
    // bylu
    if(IM == 1){
        str += '<a id="IM" class="qq j-icon a" style="color: #fff;" onclick="openWin(this)" href="javascript:;"  class="seller-btn"><i class="icon">在线客服</i></a>';
    ...
    if(IM == 1) {
        ...
        str += '<p class="tencent-p">在线客服<br>点击交谈</p>';
        str += '</a>';
        str += '</div>';
    }else{
        str += '<div class="tencent j-tencent j-box">';
