...
$(function(){
	...
	*/
	...
	function add_gift_cart(act_id)
	{
		...
		Ajax.call('flow.php?step=add_favourable', 'act_id=' + act_id + select_flag + '&select_gift=' + select_gift, add_gift_cart_response, 'POST', 'JSON');
	}
    ...
    $(document).on('click','.trade-btn',function(){
        ...
        var gift = $("#product_promo_"+favourable_id);
        ...
        Ajax.call('flow.php?step=show_gift_div', 'favourable_id=' + favourable_id + select_flag, show_gift_div_response, 'POST', 'JSON');
    });
