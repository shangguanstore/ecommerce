...
$_LANG['cfg_range']['add_shop_price']['0'] = 'SKU价格';
$_LANG['cfg_range']['add_shop_price']['1'] = 'SUK价格（商品价格 + 属性货品价格）';
...
$_LANG['cfg_desc']['site_domain'] = '输入您的网站域名，避免启用商家二级域名出现问题（如：http://www.ecmoban.com/）';
...
$_LANG['cfg_range']['sms_type']['1'] = '阿里大鱼';
...
$_LANG['cfg_name']['marticle'] = '商家入驻文章列表';
$_LANG['cfg_desc']['marticle'] = '设置商家入驻首页左侧文章ID,文本框中填写文章分类ID';

$_LANG['cfg_name']['marticle_id'] = '商家入驻文章默认内容';
$_LANG['cfg_desc']['marticle_id'] = '设置默认显示商家入驻文章内容ID';
...
$_LANG['cfg_name']['review_goods'] = '审核商家商品';
...
$_LANG['cfg_desc']['two_code_links'] = '域名为商品跳转的地址，系统会自动匹配每个商品的id。域名格式：http://wap.ecmoban.com';
...
$_LANG['cfg_name']['grade_apply_time'] = '商家等级未支付申请存活时间';//by kong grade
$_LANG['cfg_name']['apply_options'] = '商家升级剩余预付款处理';
