...
// 批量上传商品的字段
$_LANG['upload_product']['goods_sn'] = '商品编号';
$_LANG['upload_product']['warehouse_id'] = '仓库';
//$_LANG['upload_product']['goods_attr'] = '属性类型';
//$_LANG['upload_product']['product_sn'] = '货号';
//$_LANG['upload_product']['product_number'] = '库存';

$_LANG['save_products'] = '保存货品成功';
$_LANG['14_batch_add'] = '仓库货品列表';
$_LANG['13_batch_add'] = '仓库属性批量上传';
