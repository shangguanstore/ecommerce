...
class wxpay
{
    ...
    function get_code($order, $payment)
    {
        ...
        elseif($result["code_url"] != NULL)
        {
			...
			return '<a href="javascript:;" class="weizf">微信支付</a><div style="margin: 0 0 0 150px; width: 100px; overflow: hidden; text-align: center;display: none;" class="wxzf"><span>微信支付扫一扫</span><img src="'.$GLOBALS['ecs']->url(). 'images/qrcode/'.basename($filename).'?t='.time().'" /></div>';
        }
    }
