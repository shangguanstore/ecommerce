...
//@author guan start
if ($_REQUEST['act'] == 'delete_two_logo')
{
	$sql = "UPDATE ". $ecs->table('shop_config') . " SET value='' WHERE id='$_REQUEST[id]' AND code='$_REQUEST[code]'";
	if($db->query($sql))
	{
		ecs_header("location: shop_config.php?act=list_edit");
		exit;
	}
	else
	{
