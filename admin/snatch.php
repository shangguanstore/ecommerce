...
elseif ($_REQUEST['act'] =='insert')
{
    ...
    /* 检查商品是否存在 */
    $sql = "SELECT goods_name FROM ".$ecs->table('goods')." WHERE goods_id = '$_POST[activity_goods]'";
    ...
    $record = array(
        ...
        'act_type'=>GAT_SNATCH, 'goods_id'=>$_POST['activity_goods'], 'goods_name'=>$_POST['goods_name'],
...
elseif ($_REQUEST['act'] =='update')
{
    ...
    /* 更新数据 */
    $record = array('act_name' => $_POST['snatch_name'], 'goods_id' => $_POST['activity_goods'],
...
{    
    ...
    if ($result === false)
    {
        ...
        /* 获活动数据 */
        $sql = "SELECT ga.act_id, ga.act_name AS snatch_name, ga.goods_name, ga.start_time, ga.end_time, ga.is_finished, ga.ext_info, ga.product_id, ga.user_id, ga.is_hot ".
...
function get_snatch_info($id)
{
    ...
    $sql = "SELECT act_id, act_name AS snatch_name, goods_id, product_id, goods_name, start_time, end_time, act_desc, act_promise, act_ensure, ext_info, is_hot" .
