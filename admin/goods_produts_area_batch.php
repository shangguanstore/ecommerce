...
elseif ($_REQUEST['act'] == 'upload')
{
	...
	$smarty->display('goods_produts_area_batch_add.htm');
}
/*------------------------------------------------------ */
//-- 动态添加数据入库;
/*------------------------------------------------------ */
...
elseif ($_REQUEST['act'] == 'download')
{
	...
	$goods_id = isset($_REQUEST['goods_id']) ? intval($_REQUEST['goods_id']) : 0;			
	$area_id = isset($_SESSION['product_area']) ? intval($_SESSION['product_area']) : 0;//当前地区ID bylu;
