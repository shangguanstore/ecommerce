...
region.rgionResponse = function(result, text_result)
{
	...
	if (result.regions && result.type == 2)
	  {
	    ...
	    for (i = 0; i < result.regions.length; i ++ )
	    {
	        html += '<li><a title="'+ result.regions[i].region_name +'" href="javascript:region.getRegion(' + result.regions[i].region_id + ', 3, district_list, ' + '\'' + result.regions[i].region_name + '\'' + ',' + result.user_id + ');">' + result.regions[i].region_name + '</a></li>';
	    }
	    div.innerHTML = html;
	...
	else if(result.regions && result.type == 3)
	{
	    ...
	    {
                if(region.detail){
                    html += '<li><a title="'+ result.regions[i].region_name +'" href="javascript:region.changedDis_pre(' + result.regions[i].region_id + ',' + result.user_id + ');">' + result.regions[i].region_name + '</a></li>';
                }else{
                    html += '<li><a title="'+ result.regions[i].region_name +'" href="javascript:region.changedDis(' + result.regions[i].region_id + ',' + result.user_id + ');">' + result.regions[i].region_name + '</a></li>';
                }
	    }
	    div.innerHTML = html;
